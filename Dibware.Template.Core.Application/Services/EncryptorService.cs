...
namespace Dibware.Template.Core.Application.Services
{
    public class EncryptorService : IEncryptorService
    {
        ...
        {
            //using (RNGCryptoServiceProvider provider = new RNGCryptoServiceProvider(value))
            //{
            //    provider.
        ...
        public String EncryptValue(String value, String salt)
        {
            return EncryptValue(String.Concat(value, salt));
        }
