...
namespace Dibware.Template.Presentation.Web.Exceptions
{
    /// <summary>
    ...
    public class ModelStateException : ApplicationException
    {
        ...
        /// <summary>
        /// Gets the error for a JsonResult.
        /// </summary>
        /// <value>The error.</value>
        public KeyValuePair<string, string>? ErrorForJsonResult
        {
            get
            {
                if (this.Errors.Count > 0)
        ...
        /// The class name is null or <see cref="P:System.InnerException.HResult"/> is zero (0).
        /// </exception>
            ...
            : base(info, context)
        {
            ...
            // deserialize
            this.Errors = info.GetValue(SerializationInfoKeys.ModelStateExceptionErrors, typeof(Dictionary<string, string>)) as Dictionary<string, string>;
        }
        ...
        public override void GetObjectData(SerializationInfo info, StreamingContext context)
        {
            ...
            // serialize errors
            info.AddValue(SerializationInfoKeys.ModelStateExceptionErrors, this.Errors, typeof(Dictionary<string, string>));
